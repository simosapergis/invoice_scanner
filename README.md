...
export FIREBASE_FUNCTION_REGION=europe-west3                 # default is us-central1
...
#$env:FIREBASE_FUNCTION_REGION = "europe-west3"
...
firebase functions:config:set region.name="europe-west3"
